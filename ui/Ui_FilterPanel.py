...
class Ui_FilterPanel(object):
    def setupUi(self, FilterPanel):
        ...
        self.label_4 = QtGui.QLabel(self.flaggedBox)
    ...
    def retranslateUi(self, FilterPanel):
        ...
        self.flagIgnore.setText(_translate("FilterPanel", "Ignore", None))
        self.flagExclude.setText(_translate("FilterPanel", "Exclude From Selection", None))
        self.flagKeep.setText(_translate("FilterPanel", "Keep Only Flagged Items", None))
        self.label_4.setText(_translate("FilterPanel", "Currently Flagged:", None))
