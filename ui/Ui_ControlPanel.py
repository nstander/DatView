...
class Ui_ControlPanel(object):
    def setupUi(self, ControlPanel):
        ...
        self.legendListView = QtGui.QListView(self.legendGroupBox)
        self.legendListView.setEditTriggers(QtGui.QAbstractItemView.EditKeyPressed|QtGui.QAbstractItemView.SelectedClicked)
        self.legendListView.setObjectName(_fromUtf8("legendListView"))
    ...
    def retranslateUi(self, ControlPanel):
        ...
        self.label_3.setText(_translate("ControlPanel", "Change field and colors for stacked histograms and aggregated plots. Double click to edit color. Single click on selected to edit name.", None))
