...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionComparison_Scatter = QtGui.QAction(MainWindow)
        self.actionComparison_Scatter.setObjectName(_fromUtf8("actionComparison_Scatter"))
        self.actionComparison_2D_Histogram = QtGui.QAction(MainWindow)
        self.actionComparison_2D_Histogram.setObjectName(_fromUtf8("actionComparison_2D_Histogram"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionComparison_Scatter.setText(_translate("MainWindow", "Comparison Scatter", None))
        self.actionComparison_2D_Histogram.setText(_translate("MainWindow", "Comparison 2D Histogram", None))
