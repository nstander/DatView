...
class Ui_ControlPanel(object):
    def setupUi(self, ControlPanel):
        ...
        self.legendListWidget = QtWidgets.QListWidget(self.legendGroupBox)
    ...
    def retranslateUi(self, ControlPanel):
        ...
        self.label_3.setText(_translate("ControlPanel", "Change field and colors for stacked histograms and aggregated plots. Click to edit color."))
